...
//    }
        ...
        public List<Auction> findAllForFilters(String title, String carMaker, String carModel, String color) {
        return auctionRepository.findAllForFilters(title, carMaker, carModel, color);
    }
